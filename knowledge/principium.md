...
The navigation root for the **claude-code-plugins** knowledge graph — durable lessons from building
Claude Code plugins, skills, and agents. Follow the links down: atlas → map → note.

- [[sources]] — processed chronicle entries and fetched docs, keyed by their canonical `source:`
